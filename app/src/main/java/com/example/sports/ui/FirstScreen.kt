    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                colors = TopAppBarDefaults.mediumTopAppBarColors(
                    containerColor = Color(0xFF346A22) // Set the background color to red
                )
            )
        },
        content = { innerPadding ->
            Column(
                modifier = Modifier
                    .fillMaxSize()
                    .background(Color(0xFF00789B)) // Set the background color to orange
                ...
                Box(
                    ...
                    Column(
                        ...
                        Text(
                            "Ülkeleri ve bayraklarını öğrenmek için bir kıta seç.",
                            fontSize = 16.sp,
                            fontWeight = FontWeight.Bold,
                            color = Color.Black,
                            modifier = Modifier.align(Alignment.CenterHorizontally)
